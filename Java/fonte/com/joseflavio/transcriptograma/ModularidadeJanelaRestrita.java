...
/**
 * Calcula a modularidade por janela restrita de uma rede ordenada.
 * @author José Flávio de Souza Dias Júnior
 * @version 2015
 */
public class ModularidadeJanelaRestrita {

	public static void main( String[] args ) {
		
		if( args.length < 3 ){
			System.out.println( "Calcula a modularidade por janela restrita de uma rede ordenada." );
			System.out.println( ModularidadeJanelaRestrita.class.getSimpleName() + " <arquivo_matriz> <arquivo_ordem> <janela:40|50|...>" );
			System.exit( 1 );
		}
		...
		try{
			...
			short[] modularidade = Ferramenta.calcularModularidadeJanelaRestrita( matriz, ordem, janela );
